...
class Incidentes(models.Model):
    ...
    CreatedDate = models.DateTimeField(null=True, blank=True, verbose_name="CreatedDate")
    ResolvedDate = models.DateTimeField(null=True, blank=True, verbose_name="ResolvedDate")
    ClosedDate = models.DateTimeField(null=True, blank=True, verbose_name="ClosedDate")
...
class Solicitudes(models.Model):
    ...
    Status = models.CharField(max_length=255, verbose_name="Status")
    Services = models.CharField(max_length=255, verbose_name="Services")
    Servicio2 = models.CharField(max_length=255, verbose_name="Services2", default='')
    CreatedDate = models.DateTimeField(null=True, blank=True, verbose_name="CreatedDate")
    ResolvedDate = models.DateTimeField(null=True, blank=True, verbose_name="ResolvedDate")
    ClosedDate = models.DateTimeField(null=True, blank=True, verbose_name="ClosedDate")
    AffectedUser = models.CharField(max_length=255, verbose_name="AffectedUser")
